...
export default function AIChat() {
  return (
    <div className="flex flex-col h-[calc(100vh-140px)] bg-panel border border-border rounded-[14px] overflow-hidden">
      <div className="flex-1 p-6 overflow-y-auto flex flex-col gap-6">
        
        {/* User Message */}
        <div className="flex gap-4 self-end max-w-[80%]">
          <div className="bg-white/5 rounded-2xl rounded-tr-sm p-4 text-[13px] text-white/90 border border-white/5">
        ...
        <div className="flex gap-4 max-w-[80%]">
          ...
          <div className="bg-accent/5 rounded-2xl rounded-tl-sm p-4 text-[13px] text-white/90 border border-accent/10">
      ...
      <div className="p-4 bg-white/5 border-t border-white/5">
        <div className="flex items-center gap-3 bg-black/20 rounded-full px-4 py-2 border border-white/10 focus-within:border-accent/50 transition-colors">
          <input 
            type="text" 
            placeholder="Ask about your form, stats, or gear..." 
