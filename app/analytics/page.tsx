  ...
  return (
    <>
      ...
      <div className="flex-1 flex flex-col items-center justify-center bg-panel border border-border rounded-[14px] p-8 text-center mt-4 h-[400px]">
        ...
        <h2 className="text-xl font-semibold text-text-mid mb-2">Analytics Dashboard</h2>
        <p className="text-sm text-text-dim max-w-sm">
          This section is currently under construction. Check back soon for deep insights into your performance.
        </p>
      </div>
    </>
  );
